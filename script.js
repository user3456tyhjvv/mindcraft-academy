...
function showAuthModal(type) {
    ...
    if (type === 'login') {
        ...
        formFooter.innerHTML = `
                ...
                <a onclick="showForgotPasswordModal()" style="font-size: 0.9rem; color: #8b4513; margin-top: 10px; display: block; cursor: pointer; text-decoration:```text
 underline;">Forgot your password?</a>
            `;
        nameGroup.style.display = 'none';
...
// Progress customization functions are now in editing.js
// Progress customization functions are now in editing.js